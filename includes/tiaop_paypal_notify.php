...
// Add tiaop_paypal_notify to the OptimizePress paypal processing hook
if(!has_filter("ws_plugin__optimizemember_during_paypal_notify_conditionals", "tiaop_paypal_notify")) {
	add_filter("ws_plugin__optimizemember_during_paypal_notify_conditionals", "tiaop_paypal_notify", 10, 2);
}
